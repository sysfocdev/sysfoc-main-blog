                              ...
                              <div class="jellywp_about_us_widget_wrapper">
                                 ...
                                 <div class="social_icons_widget">
                                    <ul class="social-icons-list-widget icons_about_widget_display">
                                       ...
                                       <li><a href="#" class="deviantart" target="_blank"><i class="fa fa-deviantart"></i></a>
                                       </li>
                                       ...
                                       <li><a href="#" class="stumbleupon" target="_blank"><i class="fa fa-stumbleupon"></i></a>
                                       </li>
                                       <li><a href="#" class="wordpress" target="_blank"><i class="fa fa-wordpress"></i></a>
                                       </li>
                                    </ul>
                                 </div>
                                 ...
                                 <ul class="feature-post-list recent-post-widget">
                                    <li>
                                       <a href="#" class="jl_small_format feature-image-link image_post featured-thumbnail" title="Round white dining table on brown hardwood">
                                          <img width="120" height="120" src="theme/disto/demo/wp-content/uploads/2019/03/daniel-korpai-1296140-unsplash-120x120.jpg" class="attachment-disto_small_feature size-disto_small_feature wp-post-image" alt="" />
                                          <div class="background_over_image"></div>
                                       </a>
                                       <div class="item-details"> <span class="meta-category-small"><a class="post-category-color-text" style="background:#36c942" href="#">Sports</a></span> 
                                          <h3 class="feature-post-title"><a href="#">
                                                   Round white dining table on brown hardwood</a>
                                                </h3>
                                          <span class="post-meta meta-main-img auto_image_with_date">                             <span class="post-date"><i class="fa fa-clock-o"></i>Mar 10, 2019</span></span>
                                       </div>
                                    </li>
                                    <li>
                                       <a href="#" class="jl_small_format feature-image-link image_post featured-thumbnail" title="People are enjoy the job that they love">
                                          <img width="120" height="120" src="theme/disto/demo/wp-content/uploads/2019/02/irina-iriser-654436-unsplash-120x120.jpg" class="attachment-disto_small_feature size-disto_small_feature wp-post-image" alt="" />
                                          <div class="background_over_image"></div>
                                       </a>
                                       <div class="item-details"> <span class="meta-category-small"><a class="post-category-color-text" style="background:#0015ff" href="#">Business</a></span> 
                                          <h3 class="feature-post-title"><a href="#">
                     ...
                     <div class="col-md-4">
                        <div id="categories-4" class="widget widget_categories">
                           ...
                           <ul>
                              ...
                              <li class="cat-item cat-item-3"><a href="#" title="Sample category description goes here">AI Tools</a>  <span>10</span>
                              </li>
                              <li class="cat-item cat-item-4"><a href="#" title="Sample category description goes here">Blog</a>  <span>5</span>
                              </li>
                              <li class="cat-item cat-item-5"><a href="#" title="Sample category description goes here">Categories</a>  <span>10</span>
                              </li>
                              <li class="cat-item cat-item-6"><a href="#" title="Sample category description goes here">Leads</a>  <span>6</span>
                              </li>
                              <li class="cat-item cat-item-7"><a href="#" title="Sample category description goes here">AI Facts</a>  <span>4</span>
                              </li>                              
                           </ul>
                        </div>
                     </div>
            ...
            <div class="footer-bottom enable_footer_copyright_dark">
               <div class="container">
                  <div class="row bottom_footer_menu_text">
                     <div class="col-md-6 footer-left-copyright">© Copyright 2023 Powered by Sysfoc</div>
